...
export const logros: Logro[] = [
    {
        ...
        skills: ['Trabajo en equipo', 'Resolución de problemas', 'Trabajo bajo presión'],
    },
    {
        ...
        skills: ['Trabajo en equipo multidisciplinar', 'Trabajo bajo presión', 'Pensamiento analítico', 'Resolución de problemas'],
    },
    {
        ...
        skills: ['Trabajo en equipo', 'Organización', 'Responsabilidad', 'Comunicación'],
    },
    {
        title: 'Miembro - Asociación de estudiantes CodeLab',
        place: 'Universidad de Zaragoza',
        year: '2025-2026',
        description: 'Miembro de la asociación de estudiantes CodeLab, de la Universidad de Zaragoza. Participación en la organización de eventos y actividades educativas relacionadas con la programación y el desarrollo de software, fomentando la colaboración y el aprendizaje entre los miembros de la comunidad estudiantil.',
        skills: ['Trabajo en equipo', 'Organización de eventos', 'Proactividad', 'Compromiso'],
    },
];
