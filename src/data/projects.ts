...
export const projects: Project[] = [
    {
        ...
        architecture: [
            'El sistema está compuesto por dos aplicaciones, una aplicación móvil y una aplicación web, y un backend que centraliza la lógica de negocio y la persistencia de datos, como se muestra en la visión conceptual del sistema.',
    ...
    },
    {
        ...
        architectureImages: ['/montgomery-safetymap/architecture/1.png'],
